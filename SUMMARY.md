...
* [Hardware and controls](getting-started/hardware-and-controls.md)
* [Quickstart](getting-started/quickstart.md)
* [Working modes](getting-started/working-modes.md)
...
* [Device not detected](troubleshooting/device-not-detected.md)
* [Device Unauthorized](troubleshooting/device-unauthorized.md)
* [Recover after a failed update](troubleshooting/firmware-recovery.md)

## Reference

* [Reference](reference/README.md)
* [Compatibility](reference/compatibility.md)
* [PN532 CLI command reference](reference/command-reference.md)
* [Firmware history](reference/firmware-history.md)
* [Safe and authorized use](reference/safe-use.md)
